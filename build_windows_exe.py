...
PYINSTALLER_URL = 'https://github.com/pyinstaller/pyinstaller/archive/refs/tags/v6.11.1.zip'
...
if need_pyinstaller:
    ...
    urlretrieve(PYINSTALLER_URL, filename=PYINST_ZIPFILE)
...
build_cmd = [os.path.join(os.environ["SYSTEMDRIVE"] + "\\", 'Python312', 'python.exe'),
